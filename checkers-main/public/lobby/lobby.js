...
const editAccountInfoTemplate = document.getElementById(
  "edit-account-info-template"
);
const uploadProfilePictureTemplate = document.getElementById(
  "upload-profile-picture-template"
);

// Functions
const removeModal = () => {
  if ($accountModal.childElementCount === 1)
    $accountModal.removeChild($accountModal.lastElementChild);
};
...
const renderAccountModal = () => {
  ...
  accountModal.firstElementChild.addEventListener("click", (event) =>
  ...
  editAccountButton.addEventListener("click", () => {
    ...
    form.addEventListener("submit", (event) => {
      ...
      const first_name =
        form.firstElementChild.children[0].lastElementChild.value;
      const last_name =
        form.firstElementChild.children[1].lastElementChild.value;
      const username =
        form.firstElementChild.children[2].lastElementChild.value;
      const email = form.firstElementChild.children[3].lastElementChild.value;
      const password =
        form.firstElementChild.children[4].lastElementChild.value;
  ...
  uploadProfilePicture.addEventListener("click", () => {
    ...
    const uploadProfilePicture =
      uploadProfilePictureTemplate.content.cloneNode(true);
